...
DETERMINISTIC_INTENT_KEYWORDS: list[tuple[str, list[str]]] = [
    ...
    ("fd.summary", [
        ...
        "ایف ڈی ہیں", "ایف ڈیز", "ایف ڈی اماؤنٹ", "اماؤنٹ کتنا",
        "एफडीज़ के बारे", "एफडीज के बारे", "एफडी के बारे", "माझ्या एफडी", "ਐਫਡੀਜ਼ ਬਾਰੇ", "ਐਫਡੀ ਬਾਰੇ", "ایف ڈیز کے بارے", "ایف ڈی کے بارے", "ایف ڈی لسٹ",
